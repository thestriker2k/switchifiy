    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-800 to-black">
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute bottom-1/4 right-0 w-80 h-80 bg-emerald-500/15 rounded-full blur-[100px] animate-pulse"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute top-1/2 left-1/3 w-64 h-64 bg-violet-500/10 rounded-full blur-[80px] animate-pulse"
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight tracking-tight">
                Peace of mind,
                <br />
                <span className="italic text-[#3EEBBE]">automated.</span>
              </h1>
              <p className="text-lg text-gray-400 max-w-md leading-relaxed">
                Set up safety notifications that alert your loved ones if you
                don't check in. Simple, reliable, and always watching.
              </p>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-4 rounded-xl bg-gray-50 border border-gray-100">
              ...
              <div className="text-sm text-gray-600">
                ...
                <p>
                  We use Google's secure authentication to keep your account
                  safe. No passwords to remember or manage.
                </p>
              </div>
            </div>
          </div>
